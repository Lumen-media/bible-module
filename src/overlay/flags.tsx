  ...
  return (
    <svg className={className} viewBox="0 0 513 342" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#pt)">
        ...
        <path
          d="M197.025 235.125C232.44 235.125 261.15 206.416 261.15 171C261.15 135.585 232.44 106.875 197.025 106.875C161.61 106.875 132.9 135.585 132.9 171C132.9 206.416 161.61 235.125 197.025 235.125Z"
          fill="#FFDA44"
        />
        <path
          d="M160.952 138.938V179.017C160.952 198.938 177.101 215.087 197.022 215.087C216.943 215.087 233.092 198.938 233.092 179.017V138.938H160.952Z"
          fill="#D80027"
        />
        <path
          d="M197.022 191.04C190.392 191.04 184.999 185.646 184.999 179.016V162.985H209.046V179.016C209.045 185.645 203.651 191.04 197.022 191.04Z"
          fill="white"
        />
      </g>
      <defs>
...
export function UKFlag({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 256 171" xmlns="http://www.w3.org/2000/svg">
      <rect width="256" height="171" fill="#012169" />
      <path d="M0 0l14 12 14-12v4L18 12l10 10v4L14 16 4 26v-4l10-10L0 4z" fill="#FFF" />
      <path d="M8 0l10 8 10-8v2L18 10 8 2z" fill="#C8102E" transform="rotate(90 18 14)" />
      <path d="M0 14h256v4H0z" fill="#FFF" />
      <path d="M0 16h256v2H0z" fill="#C8102E" />
      <path d="M119 0h18v171h-18z" fill="#FFF" />
      <path d="M128 0h18v171h-18z" fill="#C8102E" />
      <path d="M2 0l12 10L0 26v-4l10-8L0 4z" fill="#C8102E" transform="rotate(90 18 14)" />
    </svg>
  );
}
  ...
  return (
    <svg className={className} viewBox="0 0 513 342" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#us)">
        ...
        <path
          d="M0 0H513V26.3H0V0ZM0 52.6H513V78.9H0V52.6ZM0 105.2H513V131.5H0V105.2ZM0 157.8H513V184.1H0V157.8ZM0 210.5H513V236.8H0V210.5ZM0 263.1H513V289.4H0V263.1ZM0 315.7H513V342H0V315.7Z"
          fill="#D80027"
        />
  ...
  return (
    <svg className={className} viewBox="0 0 513 342" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#es)">
        ...
        <path
          d="M0 0.240234H512V91.4402H0V0.240234ZM0 251.04H512V342.24H0V251.04Z"
          fill="#D03433"
        />
        <path d="M0 91.2402H512V251.24H0V91.2402Z" fill="#FBCA46" />
        <path d="M177.493 159.84H200.249V171.24H177.493V159.84Z" fill="white" />
        <path
          d="M163.84 194.04C163.84 200.88 170.667 205.44 177.493 205.44C184.32 205.44 191.147 200.88 191.147 194.04L193.422 159.84H161.564L163.84 194.04ZM150.187 159.84C150.187 153 154.738 148.44 159.289 148.44H193.422C200.249 148.44 204.8 153 204.8 157.56V159.84L202.524 194.04C200.249 207.72 191.147 216.84 177.493 216.84C163.84 216.84 154.738 207.72 152.462 194.04L150.187 159.84Z"
          fill="#A41517"
        />
        <path
          d="M154.738 171.24H200.249V182.64H188.871L177.493 205.44L166.116 182.64H154.738V171.24ZM120.604 137.04H143.36V216.84H120.604V137.04ZM211.627 137.04H234.382V216.84H211.627V137.04ZM154.738 125.64C154.738 118.8 159.289 114.24 166.116 114.24H188.871C195.698 114.24 200.249 118.8 200.249 125.64V130.2C200.249 134.76 197.973 137.04 193.422 137.04H159.289C157.013 137.04 154.738 134.76 154.738 132.48V125.64Z"
          fill="#A41517"
        />
      </g>
      <defs>
  ...
  return (
    <svg className={className} viewBox="0 0 513 342" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#ar)">
        ...
        <path
          d="M256.5 211C278.591 211 296.5 193.091 296.5 171C296.5 148.909 278.591 131 256.5 131C234.409 131 216.5 148.909 216.5 171C216.5 193.091 234.409 211 256.5 211Z"
          fill="#FFDA44"
        />
        <path
          fillRule="evenodd"
